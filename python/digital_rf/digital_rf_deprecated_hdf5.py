...
class read_hdf5:
    ...
    def get_metadata(self, channel_name, timestamp=None):
        ...
        """
        warnings.warn("get_metadata is now deprecated.  Use get_rf_file_metadata for metadata within the Digital RF standard, or Digital Metdata for other metadata.",
                      DeprecationWarning)
