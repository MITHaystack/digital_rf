...
def _add_message_group(parser):
    ...
    messagegroup.add_argument(
        ...
        action="store_true",
        help="""enable fast zmq message passing to access radio settings while running
                (default: False)""",
    )
    messagegroup.add_argument(
        "--sub",
        dest="zmq_sub_port",
        type=evalint,
        help="""port number to listen for zmq control messages for the usrp
                (default: 5563)""",
    )
    messagegroup.add_argument(
        "--pub",
        dest="zmq_pub_port",
        type=evalint,
        help="""port number for to publish zmq response messages for the usrp
                (default: 5562)""",
    )
    return parser
